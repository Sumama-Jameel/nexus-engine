...
func TestValidateRemoteURL(t *testing.T) {
        tests := []struct {
                ...
                },
                {
                        ...
                        url:     "https://raw.githubusercontent.com/Sumama-Jameel/profiles?param=value",
                        wantErr: true,
                },
                {
                        name:    "fragment rejected",
                        url:     "https://raw.githubusercontent.com/Sumama-Jameel/profiles#section",
                        wantErr: true,
                },
        }
...
func TestValidateRemoteURL_RejectsHTTP(t *testing.T) {
        err := validateRemoteURL("http://raw.githubusercontent.com/Sumama-Jameel/profiles")
        if err == nil {
...
func TestValidateRemoteURL_RejectsQueryParams(t *testing.T) {
        err := validateRemoteURL("https://raw.githubusercontent.com/Sumama-Jameel/profiles?ref=main")
        if err == nil {
...
func TestFetchProfile_URLWithQueryParams(t *testing.T) {
        ...
        err := store.FetchProfile("test", "https://raw.githubusercontent.com/Sumama-Jameel/profiles?ref=main")
        if err == nil {
...
func TestFetchProfile_URLWithUserinfo(t *testing.T) {
        ...
        err := store.FetchProfile("test", "https://user:pass@raw.githubusercontent.com/Sumama-Jameel/profiles")
        if err == nil {
...
func TestValidateRemoteURL_FragmentRejected(t *testing.T) {
        err := validateRemoteURL("https://raw.githubusercontent.com/Sumama-Jameel/profiles#section")
        if err == nil {
